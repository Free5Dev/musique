<?php 
    ...
    $reqBlog=$bdd->query("SELECT * FROM blog ORDER BY id DESC LIMIT 20");
    // form de search 
    if(isset($_GET['btnSearch'])){
        // verification de la saisie du champs de reserch
        if(!empty($_GET['search'])){
            $reqBlog=$bdd->prepare("SELECT * FROM blog WHERE titre like ? ORDER BY id DESC LIMIT 20");
            $reqBlog->execute(array("%$_GET[search]%"));
        }
    }
?>
<!DOCTYPE html>
...
<body>
   ...
   <section class="container-fluid indexMusicFluid">
       <h1 >Gestions de Blog</h1>
       <div class="row indexMusicRow">
           <div class="col-md-6 indexMusicCol">
               <p><a href="ajoutBlog.inc.php" class="btn btn-primary">Ajouter une Actualité au Blog</a></p>
           </div>
           <div class="col-md-6 indexMusicCol">
       ...
       <div class="row indexMusicRow">
           <div class="col-md-12">
               <table class="table table-hover ">
                   ...
                   <tr>
                       <td><?php echo htmlspecialchars($donneesBlog['titre']); ?></td>
                       <td> <img src="<?php echo htmlspecialchars($donneesBlog['photoBlog']); ?>" alt="" style="width:80px;height:50px;" class="img-responsive"> </td>
                       <td> <a href="modifBlog.inc.php?ref=<?php echo $donneesBlog['id']; ?>">Modification</a> </td>
                       <td> <a href="supprimBlog.inc.php?ref=<?php echo $donneesBlog['id']; ?>">Suppression</a> </td>
                   </tr>
