<?php 
    ...
    require_once("../connexion.inc.php");
     ...
     $reqTalent=$bdd->query("SELECT * FROM talent ORDER BY id DESC LIMIT 20");
    // form de search 
    if(isset($_GET['btnSearch'])){
        // verification de la saisie du champs de reserch
        if(!empty($_GET['search'])){
            $reqTalent=$bdd->prepare("SELECT * FROM talent WHERE titre like ? ORDER BY id DESC LIMIT 20");
            $reqTalent->execute(array("%$_GET[search]%"));
        }
    }
...
<body>
   ...
   <section class="container-fluid indexMusicFluid">
       <h1 >Gestions des Talents</h1>
       <div class="row indexMusicRow">
           <div class="col-md-6 indexMusicCol">
               <p><a href="ajoutTalent.inc.php" class="btn btn-primary">Ajouter Talent</a></p>
           </div>
           <div class="col-md-6 indexMusicCol">
       ...
       <div class="row indexMusicRow">
           <div class="col-md-12">
               <table class="table table-hover ">
                   ...
                   <tr>
                       <td><?php echo htmlspecialchars($donneesTalent['titre']); ?></td>
                       <td><?php echo htmlspecialchars($donneesTalent['nomTalent']); ?></td>
                       <td> <img src="<?php echo htmlspecialchars($donneesTalent['photoTalent']); ?>" alt="" style="width:80px;height:50px;" class="img-responsive"> </td>
                       <td> <a href="modifTalent.inc.php?ref=<?php echo $donneesTalent['id']; ?>">Modification</a> </td>
                       <td> <a href="supprimTalent.inc.php?ref=<?php echo $donneesTalent['id']; ?>">Suppression</a> </td>
                   </tr>
