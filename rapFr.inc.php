                ...
                <?php while($donneesFr=$reqFr->fetch()) { ?>
                    <div class="col-sm-12 col-md-6 colRapUsaGaucheElementVideo">
                        ...
                        <div class="colRapUsaGaucheElementVideoElement">
                            <h3><a href="rapFrCommentaire.inc.php?ref=<?php echo htmlspecialchars($donneesFr['id']); ?>"><span class="text-danger">Artiste(s):</span> <?php echo htmlspecialchars($donneesFr['nomArtiste']); ?> <span class="text-danger">Titre:</span> <?php echo htmlspecialchars($donneesFr['titre']); ?></a></h3>
