<?php 
    ...
    // requete pour rap Fr
    $reqFr=$bdd->query("SELECT z.id,z.nomArtiste,z.titre,z.url,z.description,z.photo,z.origine,date_format(datePub, 'Le %d/%M/%Y à %Hh%i') as datePub,z.idMembre,z.idMusiqueCategorie,m.nom FROM musiques as z,membres as m WHERE z.idMembre=m.id AND z.idMusiqueCategorie=2 ORDER BY ID DESC LIMIT 15");
    //   requete blog kbz
                ...
                <?php while($donneesFr=$reqFr->fetch()) { ?>
                    <div class="col-sm-12 col-md-4 colRapUsaGaucheElementVideo">
                        ...
                        <div class="colRapUsaGaucheElementVideoElement">
                            ...
                            <p id="img"><a href="rapFrCommentaire.inc.php?ref=<?php echo htmlspecialchars($donneesFr['id']); ?>"><img class="img-fluid img" src="<?php echo $donneesFr['photo']; ?>" /></a></p>
                            <p class="p1"><i class="fas fa-calendar-alt"></i> <?php echo htmlspecialchars($donneesFr['datePub']); ?></small></p>
                            ...
                            <p class="p4"><a href="rapFrCommentaire.inc.php?ref=<?php echo htmlspecialchars($donneesFr['id']); ?>">Commentaires</a></p>
