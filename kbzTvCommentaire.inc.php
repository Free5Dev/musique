        ...
        <section class="row rowAccueil">
            ...
            <article class="col-sm-12 col-md-9 colRapUsaGauche"  style="background-color:#fff;">
               <div class="row rowCommentaire"  style="background-color:#D3D3D3;">
                   <div class="col-md-12 colCommentaire">
                       ...
                       <h3><?php echo htmlspecialchars($donneesKbzTv['titre']); ?></h3>
                            <p class="p1" style="margin-bottom:0;"><strong class="text-danger">Presentatrice: </strong><small><i class="fas fa-user-edit"></i> <?php echo htmlspecialchars($donneesKbzTv['presentatrice']); ?></small> <strong class="text-danger">Date:</strong> <small><i class="fas fa-calendar-alt"></i> <?php echo htmlspecialchars($donneesKbzTv['dateTv']); ?></small><strong class="text-danger"> Stars:</strong> <small><i class="fas fa-calendar-alt"></i> <?php echo htmlspecialchars($donneesKbzTv['invite']); ?></small></p>
                   ...
                   <div class="col-md-12 colCommentaire">
                       ...
                       <div id="fb-root"></div>
                            ...
                            <div class="fb-comments" data-href="http://localhost/musique/kbzTvCommentaire.inc.php?ref=<?php echo htmlspecialchars($donneesKbzTv['id']); ?>" data-width="100%" data-numposts="5"></div>
                       </p>
                   </div>
                   <!--  -->
               </div>
            ...
            <article class="col-sm-12 col-md-3 colAccueilDroite" style="background-color:#fff;">     
                ...
                <h2>Même Categories</h2>  
                    <?php while($donneesKbzTvMm=$reqKbzTvMm->fetch()) { ?>
                    <div class="col-md-12 colCommentaire">
                       <h5><span class="text-danger">Invité(e)s:</span><small><?php echo htmlspecialchars($donneesKbzTvMm['invite']); ?></small></h5>
                       <p  class="img-fluid img-responsive"><a href="kbzTvCommentaire.inc.php?ref=<?php echo $donneesKbzTvMm['id']; ?>"><img src="<?php echo htmlspecialchars($donneesKbzTvMm['photoKbzTv']); ?>" alt=""></a></p>
                       <p class="voir"><a href="kbzTvCommentaire.inc.php?ref=<?php echo $donneesKbzTvMm['id']; ?>" class="btn btn-success btn-sm">Voir détails</a></p>
                   </div>
                    <?php } $reqKbzTvMm->closeCursor(); ?>
               </div>
            </article>
