<?php 
    ...
    if(isset($_GET['ref'])){
        ...
        $reqFr=$bdd->prepare("SELECT z.id,z.nomArtiste,z.titre,z.url,z.description,z.photo,z.origine,date_format(datePub, 'Le %d/%m/%Y à %Hh%i') as datePub,z.idMembre,z.idMusiqueCategorie,m.nom FROM musiques as z,membres as m WHERE z.idMembre=m.id AND z.id=? ");
    ...
    $reqMm=$bdd->prepare("SELECT z.id,z.nomArtiste,z.titre,z.url,z.description,z.photo,z.origine,date_format(datePub, 'Le %d/%m/%Y à %Hh%imin%ss') as datePub,z.idMembre,z.idMusiqueCategorie,m.nom FROM musiques as z,membres as m WHERE z.idMembre=m.id AND z.idMusiqueCategorie=3 AND z.id!=? ORDER BY id DESC LIMIT 1,5");
    $reqMm->execute(array($_GET['ref']));
    
     //   requete Meme artiste
     $reqMArtiste=$bdd->prepare("SELECT z.id,z.nomArtiste,z.titre,z.url,z.description,z.photo,z.origine,date_format(datePub, 'Le %d/%m/%Y à %Hh%imin%ss') as datePub,z.idMembre,z.idMusiqueCategorie,m.nom FROM musiques as z,membres as m WHERE z.idMembre=m.id AND z.idMusiqueCategorie=3 AND z.id!=? ORDER BY id DESC LIMIT 6,6");
            ...
            <article class="col-sm-12 col-md-9 colRapUsaGauche"  style="background-color:#fff;">
               <div class="row rowCommentaire"  style="background-color:#D3D3D3;">
                   <div class="col-md-12 colCommentaire">
                        <h3><span class="text-danger"><?php echo htmlspecialchars($donneesFr['nomArtiste']); ?></span>- <?php echo htmlspecialchars($donneesFr['titre']); ?></h3>
                   ...
                   <div class="col-md-12 colCommentaire">
                       ...
                       <div id="fb-root"></div>
                            ...
                            <div class="fb-comments" data-href="http://localhost/musique/rapAfroCommentaire.inc.php?ref=<?php echo htmlspecialchars($donneesFr['id']); ?>" data-width="100%" data-numposts="5"></div>
                       </p>
                   </div>
                   <!--  -->
                    <!--  -->
                   <div class="col-md-12 colCommentaire">
                        ...
                        <div class="row rowMemeArtiste">
                            ...
                            <div class="col-sm-12 col-md-4 colMemeArtiste">
                                ...
                                <p  class="img-fluid img-responsive"><a href="rapAfroCommentaire.inc.php?ref=<?php echo $donneesMmArtiste['id']; ?>"><img src="<?php echo htmlspecialchars($donneesMmArtiste['photo']); ?>" alt=""></a></p>
                                <p class="voir"><a href="rapAfroCommentaire.inc.php?ref=<?php echo $donneesMmArtiste['id']; ?>" class="btn btn-success btn-sm">Voir détails</a></p>
                            </div>
            ...
            <article class="col-sm-12 col-md-3 colAccueilDroite" style="background-color:#fff;">     
                ...
                <h2>Même Categories</h2>  
                    ...
                    <div class="col-md-12 colCommentaire">
                       ...
                       <p  class="img-fluid img-responsive"><a href="rapAfroCommentaire.inc.php?ref=<?php echo $donneesMm['id']; ?>"><img src="<?php echo htmlspecialchars($donneesMm['photo']); ?>" alt=""></a></p>
                       <p class="voir"><a href="rapAfroCommentaire.inc.php?ref=<?php echo $donneesMm['id']; ?>" class="btn btn-success btn-sm">Voir détails</a></p>
                   </div>
                    <?php } $reqMm->fetch(); ?>
               </div>
            </article>
